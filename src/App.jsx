    ...
    const refreshFromStorage = (rawValue) => {
      ...
      try {
        ...
        setAppState((prev) => ({
          ...prev,
          ...nextState,
          settings: { ...prev.settings, ...(nextState.settings && typeof nextState.settings === 'object' ? nextState.settings : {}) },
          categories: Array.isArray(nextState.categories) ? nextState.categories : prev.categories,
          products: Array.isArray(nextState.products) ? nextState.products : prev.products,
          reviews: Array.isArray(nextState.reviews) ? nextState.reviews : prev.reviews,
          messages: Array.isArray(nextState.messages) ? nextState.messages : prev.messages,
          team: Array.isArray(nextState.team) ? nextState.team : prev.team,
          cart: Array.isArray(nextState.cart) ? nextState.cart : prev.cart,
          analytics: { ...defaultAnalytics, ...prev.analytics, ...(nextState.analytics && typeof nextState.analytics === 'object' ? nextState.analytics : {}) },
